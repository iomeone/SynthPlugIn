...
//==============================================================================
void SVFilter::setFilterType(const int& newType)
{
    filterType = newType;
}

void SVFilter::setCutoffPitch(const float& newCutoffPitch)
{
    if (active) {
...
void SVFilter::setCutoffFreq(const float& newCutoffFreq)
{
    if (active) {
...
void SVFilter::setResonance(const float& newResonance)
{
    if (active) {
...
void SVFilter::setQ(const float& newQ)
{
    if (active) {
        Q = newQ;
        calcFilter();
...
void SVFilter::setShelfGain(const float& newGain)
{
    if (active) {
        shelfGain = newGain;
        calcFilter();
...
void SVFilter::setFilter(const int& newType, const float& newCutoffFreq,
...
void SVFilter::setSampleRate(const float& newSampleRate)
{
...
/*void SVFilter::setSmoothingTimeInMs(const float & newSmoothingTimeMs)
{
    smoothTimeMs = newSmoothingTimeMs;
}*/

void SVFilter::setIsActive(bool isActive)
{
    active = isActive;
}

//==============================================================================
void SVFilter::calcFilter()
{
    if (active) {
...
float SVFilter::processAudioSample(const float& input, const int& channelIndex)
{
    if (active) {
...
void SVFilter::processAudioBlock(float* const samples,  const int& numSamples, 
